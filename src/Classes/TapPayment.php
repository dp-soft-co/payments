...
class TapPayment extends BaseController implements PaymentInterface
{
    ...
    {
        $this->currency = config('dpsoft-payments.TAP_CURRENCY');
        $this->tap_secret_key = config('dpsoft-payments.TAP_SECRET_KEY');
        $this->tap_public_key = config('dpsoft-payments.TAP_PUBLIC_KEY');
        $this->tap_lang_code = config('dpsoft-payments.TAP_LANG_CODE');
