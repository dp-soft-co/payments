...
class FawryPayment extends BaseController implements PaymentInterface 
{
    ...
    {
        $this->fawry_url = config('dpsoft-payments.FAWRY_URL');
        $this->fawry_merchant = config('dpsoft-payments.FAWRY_MERCHANT');
        $this->fawry_secret = config('dpsoft-payments.FAWRY_SECRET');
        $this->fawry_display_mode = config('dpsoft-payments.FAWRY_DISPLAY_MODE');
        $this->fawry_pay_mode = config('dpsoft-payments.FAWRY_PAY_MODE');
    ...
    {
        return view('dpsoft::html.fawry', ['model' => $this, 'data' => $data])->render();
    }
