...
class PayeerPayment extends BaseController implements PaymentInterface 
{
    ...
    {
        $this->payeer_api_key = config('dpsoft-payments.PAYEER_API_KEY');
        $this->payeer_additional_api_key = config('dpsoft-payments.PAYEER_ADDITIONAL_API_KEY');
        $this->payeer_merchant_id = config('dpsoft-payments.PAYEER_MERCHANT_ID');
