...
class TelrPayment extends BaseController implements PaymentInterface 
{
    ...
    {
        $this->telr_merchant_id = config('dpsoft-payments.TELR_MERCHANT_ID');
        $this->telr_api_key = config('dpsoft-payments.TELR_API_KEY');
        $this->telr_mode= config('dpsoft-payments.TELR_MODE');
    ...
    public function pay($amount = null, $user_id = null, $user_first_name = null, $user_last_name = null, $user_email = null, $user_phone = null, $source = null): array
    {
        ...
        $data = [
            ...
            'return_auth'=> route($this->verify_route_name,['gateway' =>"telr",'payment_id'=>$uniqid]),
            'return_decl'=> route($this->verify_route_name,['gateway' =>"telr",'payment_id'=>$uniqid]),
            'return_can'=> route($this->verify_route_name,['gateway' =>"telr",'payment_id'=>$uniqid]),
