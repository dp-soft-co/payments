...
class ClickPayPayment extends BaseController implements PaymentInterface 
{
    ...
    {
        $this->clickpay_server_key = config('dpsoft-payments.CLICKPAY_SERVER_KEY');
        $this->clickpay_profile_id = config('dpsoft-payments.CLICKPAY_PROFILE_ID');
    ...
    public function pay($amount = null, $user_id = null, $user_first_name = null, $user_last_name = null, $user_email = null, $user_phone = null, $source = null): array
    {
        ...
        $response = \Http::withHeaders([
            ...
            "hide_shipping"=> true,                
            "callback"=> route($this->verify_route_name,['gateway' =>"clickpay",'payment_id'=>$uniqid]),
            "return" => str_replace('https','http',route($this->verify_route_name,['gateway' =>"clickpay",'payment_id'=>$uniqid])),
            "framed" => false,
            "framed_return_top" => false,
            "framed_return_parent" => false,
            "hide_shipping" => true
